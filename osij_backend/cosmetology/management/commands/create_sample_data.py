    ...
    def handle(self, *args, **kwargs):
        ...
        for stylist_data in stylists_data:
            ...
            if stylist_created:
                ...
                self.stdout.write(self.style.WARNING(f'Stylist already exists: {stylist.user.get_full_name()}'))

        self.stdout.write(self.style.SUCCESS('\nSample data creation completed!'))
        self.stdout.write(self.style.SUCCESS(f'Created {len(created_services)} services and {len(created_stylists)} stylists'))
