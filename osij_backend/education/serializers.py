...
class CourseSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'instructor', 'instructor_name', 'thumbnail', 'thumbnail_url',
            'is_active', 'created_at', 'lessons_count'
        ]
...
class EnrollmentSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Enrollment
        fields = ['id', 'user', 'course', 'course_title', 'course_thumbnail', 
...
class LiveSessionSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = LiveSession
        fields = ['id', 'course', 'course_title', 'course_thumbnail', 'title',
                 'zoom_meeting_id', 'zoom_meeting_url', 'start_time', 'end_time',
                 'duration_minutes', 'is_recurring', 'recording_url', 'lesson', 'lesson_title']
