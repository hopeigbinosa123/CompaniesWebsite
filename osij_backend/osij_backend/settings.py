...
SPECTACULAR_SETTINGS = {
    "TITLE": "OSIJ Platform API",
    "DESCRIPTION": "API documentation for the OSIJ Fullstack Platform",
    "VERSION": "1.0.0",
...
# PayPal Settings
PAYPAL_RETURN_URL = env(
    "PAYPAL_RETURN_URL", default="http://localhost:3000/paypal-success"
)
PAYPAL_CANCEL_URL = env(
    "PAYPAL_CANCEL_URL", default="http://localhost:3000/paypal-cancel"
)
