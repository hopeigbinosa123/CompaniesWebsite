...
urlpatterns = [
    ...
    path(
        "requests/me/", UserServiceRequestsView.as_view(), name="user-service-requests"
    ),
    path(
        "requests/<int:pk>/",
    ...
    # Admin/Staff URLs
    path(
        "admin/requests/<int:pk>/update/",
        ServiceRequestUpdateView.as_view(),
        name="admin-service-request-update",
    ),
    path(
        "admin/requests/<int:service_request_pk>/updates/create/",
        ProjectUpdateCreateView.as_view(),
        name="admin-project-update-create",
    ),
    path(
        "admin/requests/<int:service_request_pk>/updates/",
        ProjectUpdateListView.as_view(),
        name="admin-project-update-list",
    ),
]
