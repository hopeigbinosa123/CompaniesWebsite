...
class Portfolio(models.Model):
    designer = models.ForeignKey(
        Designer, on_delete=models.CASCADE, related_name="portfolios"
    )
...
class DesignOrder(models.Model):
    ...
    designer = models.ForeignKey(
        Designer, on_delete=models.SET_NULL, null=True, related_name="orders"
    )
    ...
    reference_files = models.FileField(
        upload_to="design_references/", blank=True, null=True
    )
